 ...
 * frames quieter than a small RMS floor and frequencies outside 45–1600 Hz.
 *
...
export function detectPitch(
  ...
  // The normalized square difference function over the candidate lags only.
  // Indexed by lag so the peak scan below can read neighbours directly.
  const n = new Float32Array(maxLag + 2);
