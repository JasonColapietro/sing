...
| [assets/carousel-range-test/](assets/carousel-range-test/README.md) | **Bonus post, finished:** seven slides from chapter eight, "How to read your range test". |
| [CODEX-carousel-brief.md](CODEX-carousel-brief.md) | Standing production brief for future book carousels, including quotation, rendering, and human-review rules. |
