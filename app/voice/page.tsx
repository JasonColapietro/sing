    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 sm:py-20">
      ...
      <section className="mt-14 border-t border-line pt-10" aria-labelledby="voice-support">
        ...
        <div className="mt-5 flex flex-wrap gap-x-6 gap-y-3 text-sm">
          <a href="https://suedeai.org/voice/support/" className="text-violet-ink underline underline-offset-4">Suede Voice support</a>
          <a href="https://suedeai.org/voice/privacy/" className="text-violet-ink underline underline-offset-4">Privacy policy</a>
