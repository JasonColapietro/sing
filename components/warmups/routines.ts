...
export const ROUTINES: Routine[] = [
  {
    id: "quick",
    name: "Quick warmup",
    tagline: "Five minutes, all gentle: bubble, straw, N-hum and V, then one easy hoo.",
    pro: false,
    steps: [
      step("lip-trill-scale", 8),
      step("straw-scale", 8),
      step("n-hum-scale", 8),
      step("v-double-arpeggio", 6),
  ...
  },
  {
    id: "daily",
    name: "Daily warmup",
    tagline: "The complete ten: sirens, bubble, raspberries, hung-ee-mm, hoo, staccato, then a scale.",
    pro: false,
    steps: [
      step("ng-siren-fifth", 8),
      step("octave-siren", 6),
      step("lip-trill-scale", 11),
      step("tongue-trill-descent", 12),
      step("hung-ee-mm", 9),
      step("hoo-four-note", 9),
      step("gug-staccato", 11),
      step("five-note-scale", 11),
      step("sustained-hold", 5),
    ],
  },
  {
    id: "full",
    name: "Full warmup",
    tagline: "Fifteen minutes: the complete ten, then arpeggios, a reverse arpeggio and a run.",
    pro: false,
    steps: [
      step("ng-siren-fifth", 6),
      step("lip-trill-scale", 11),
      step("tongue-trill-descent", 10),
      step("n-hum-scale", 10),
      step("hung-ee-mm", 9),
      step("hoo-four-note", 8),
      step("gug-staccato", 11),
      step("v-double-arpeggio", 8),
      step("octave-arpeggio", 10),
      step("hoo-descending-arpeggio", 7),
  ...
  },
  {
    ...
    steps: [
      ...
      step("ng-siren-fifth", 6),
      step("octave-siren", 6),
      step("hoo-descending-arpeggio", 8),
